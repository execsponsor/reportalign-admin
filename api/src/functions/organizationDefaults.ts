...
const HARDCODED_DEFAULTS = {
  ...
  default_report_template: {
    ...
    sections: [
      ...
      { id: 'milestoneDelivery', label: 'Milestone Delivery Metrics', description: 'Delivery accuracy and milestones planned vs achieved', visible: false, order: 8 },
      { id: 'criticalPath', label: 'Critical Path', description: 'Critical path stability, changes and reasons', visible: false, order: 9 },
      { id: 'routeToGreen', label: 'Route to Green', description: 'Recovery plan to return the programme to green status', visible: false, order: 10 },
      { id: 'cumulativeSpend', label: 'Cumulative Spend', description: 'Running total of planned vs actual spend variance', visible: false, order: 11 },
      { id: 'dependencies', label: 'Dependencies', description: 'Inbound and outbound dependency health', visible: false, order: 12 },
      { id: 'resourceGaps', label: 'Resource Gaps', description: 'Critical roles at risk and capacity concerns', visible: false, order: 13 },
      { id: 'financial', label: 'Financial Summary', description: 'Budget vs actual financial performance', visible: false, order: 14 },
      { id: 'attachments', label: 'Attachments', description: 'Supporting documents and files', visible: true, order: 15 },
    ],
